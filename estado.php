...
if($_GET["id"]=="failure"){
$mensaje="La transacción ha fallado, intente nuevamente!";
}
if($_GET["id"]=="pending"){
$mensaje="El pago se encuentra pendiente!";
}
...
<ul>
 <li><?php echo utf8_encode("Método de pago: ").$_GET["payment_type"]; ?></li>
 <li><?php echo utf8_encode("Referencia: ").$_GET["external_reference"]; ?></li>
 <li><?php echo utf8_encode("ID del pago: ").$_GET["collection_id"]; ?></li>
 </ul>                                       
                                    </div>
